label_dict = {
    ...
    "hww_munuqq_semimerged": {"legend": "H(WW) mu semi-merged","label": "fj_isHWW_munuqq_semimerged"},
    "hww_elenuqq_merged": {"legend": "H(WW) ele merged", "label": "fj_isHWW_elenuqq_merged"},
    "hww_elenuqq_semimerged": {"legend": "H(WW) ele semi-merged","label": "fj_isHWW_elenuqq_semimerged",},
    "hww_taunuqq_merged": {"legend": "H(WW) tau merged", "label": "fj_isHWW_taunuqq_merged"},
    "hww_taunuqq_semimerged": {"legend": "H(WW) tau semi-merged","label": "fj_isHWW_taunuqq_semimerged"},

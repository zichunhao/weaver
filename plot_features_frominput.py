...
def plot_by_mass(h,vars_to_plot,plabel,args,by_proc=[]):
    ...
    for density in [True,False]:
        ...
        if density:
            fig.savefig("plots/%s/%s_by_mh_density.png"%(args.odir,plotlabel))
        else:
            fig.savefig("plots/%s/%s_by_mh.png"%(args.odir,plotlabel))
...
def plot_by_process(h,vars_to_plot,label,args):
    for density in [True,False]:
        ...
        fig.tight_layout()
        if density:
            fig.savefig("plots/%s/%s_density.png"%(args.odir,label))
        else:
            fig.savefig("plots/%s/%s.png"%(args.odir,label))
...
if __name__ == "__main__":
    ...
    ifiles = {
        "grav": "/data/shared/cmantill/training/ak15_Jul27/train/GravitonToHHToWWWW*/*.root:Events",
        "hh": "/data/shared/cmantill/training/ak15_Jul27/test/*HH*cHHH1*/*.root:Events",
        "qcd": "/data/shared/cmantill/training/ak15_Jul27/train/QCD*/*.root:Events",
        "bulk": "/data/shared/cmantill/training/ak15_Jul27/train/Bulk*/*.root:Events",
    }
    # use few files if testing script
    if args.test:
        ifiles = {
            "grav": "/data/shared/cmantill/training/ak15_Jul9/train/GravitonToHHToWWWW/nano_mc2017_87_Skim.root:Events",
            "hh": "/data/shared/cmantill/training/ak15_Jul9/test/GluGluToHHTo4V_node_cHHH1_TuneCP5_PSWeights_13TeV-powheg-pythia8/nano_mc2017_10_Skim.root:Events",
            "qcd": "/data/shared/cmantill/training/ak15_Jul27/train/QCD_HT1000to1500_TuneCP5_13TeV-madgraph-pythia8/nano_mc2017_1-101_Skim.root:Events",
            "bulk": "/data/shared/cmantill/training/ak15_Jul27/train/BulkGravitonToHHTo4Q_MX-600to6000_MH-15to250_part1_TuneCP5_13TeV-madgraph_pythia8/nano_mc2017_81_Skim.root:Events",
        }
